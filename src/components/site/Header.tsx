...
export function Header() {
  return (
    <header className="no-print sticky top-0 z-50 border-b border-forest/10 bg-paper/88 backdrop-blur-md transition-shadow duration-300 supports-[backdrop-filter]:bg-paper/72">
